...
execute as @e[type=armor_stand,name="mvm_Grenade"] run scoreboard players operation @s mvm_stickyIdDiff = @s mvm_id
scoreboard players operation @e[type=armor_stand,name="mvm_Grenade"] mvm_stickyIdDiff -= @s mvm_id

execute as @e[type=armor_stand,name="mvm_Stickybomb",scores={mvm_stickyIdDiff=0}] at @s run function mvm:classes/demoman/stickybomb
...
execute as @e[type=armor_stand,name="mvm_Grenade",scores={mvm_stickyIdDiff=0}] at @s run function mvm:classes/demoman/grenade
