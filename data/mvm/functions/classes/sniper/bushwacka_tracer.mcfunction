...
execute as @s[tag=mvm_buffed] as @e[type=marker,name="mvm_Hitbox",distance=..1,limit=1,sort=nearest] run tag @e[team=mvm_enemies,limit=1,sort=nearest] add mvm_damageCrit
execute as @e[type=marker,name="mvm_Hitbox",distance=..1,limit=1,sort=nearest] at @s run tag @e[team=mvm_enemies,limit=1,sort=nearest,tag=mvm_marked] add mvm_damageCrit
execute as @e[type=marker,name="mvm_Hitbox",distance=..1,limit=1,sort=nearest] at @s run tag @e[team=mvm_enemies,limit=1,sort=nearest,tag=mvm_jarate] add mvm_damageCrit
