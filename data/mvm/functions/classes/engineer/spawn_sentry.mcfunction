execute as @s[nbt={Item:{tag:{mvm_buildingLevel:0b}}}] run execute as @p[scores={mvm_class=6}] at @s run summon armor_stand ~ ~-1 ~ {CustomName:'"mvm_SentryGun"',Tags:[mvm_level1,mvm_construct,mvm_building],NoGravity:1b,Small:1b,ArmorItems:[{},{},{},{id:"minecraft:observer",Count:1b}],Attributes:[{Name:"minecraft:generic.max_health",Base: 200000.0d}]}
