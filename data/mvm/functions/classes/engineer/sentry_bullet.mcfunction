...
execute as @s[tag=mvm_buffed] as @e[type=marker,name="mvm_Hitbox",distance=..0.3,limit=1,sort=nearest] run tag @e[team=mvm_enemies,limit=1,sort=nearest] add mvm_damageMinicrit
...
execute as @e[type=marker,name="mvm_Hitbox",distance=..0.3,limit=1,sort=nearest] at @s run tag @e[team=mvm_enemies,limit=1,sort=nearest] add mvm_damageSentry
execute as @e[type=marker,name="mvm_Hitbox",distance=..0.3,limit=1,sort=nearest] at @s run scoreboard players add @e[team=mvm_enemies,limit=1,sort=nearest] mvm_applyDamage 16