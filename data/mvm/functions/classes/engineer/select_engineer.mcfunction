...
item replace entity @s hotbar.0 with crossbow{display:{Name:'{"text":"Rescue Ranger"}'},ChargedProjectiles:[{id:"minecraft:tipped_arrow",Count:1b,tag:{CustomPotionColor:22}}],Charged:1b,mvm_slot1:1b,mvm_weapon:1b}