scoreboard players set @s[scores={mvm_timer=0}] mvm_timer 5
...
execute as @s[scores={mvm_ammo1=1..}] run function mvm:classes/engineer/sentry_bullet_wrangled_level2
