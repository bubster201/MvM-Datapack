...
tag @e[type=marker,name="mvm_Hitbox",distance=..1,limit=1,sort=nearest,tag=mvm_backHitbox] add mvm_damageCrit
...
scoreboard players add @e[type=marker,name="mvm_Hitbox",distance=..1,limit=1,sort=nearest,tag=!mvm_backHitbox] mvm_applyDamage 40
scoreboard players add @e[type=marker,name="mvm_Hitbox",distance=..1,limit=1,sort=nearest,tag=mvm_backHitbox] mvm_applyDamage 300