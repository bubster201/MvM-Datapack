...
execute as @s[tag=mvm_critBoosted] as @e[type=marker,name="mvm_Hitbox",tag=!mvm_headHitbox,distance=..0.3,limit=1,sort=nearest] run tag @e[team=mvm_enemies,limit=1,sort=nearest] add mvm_damageCrit
execute as @s[tag=mvm_buffed] as @e[type=marker,name="mvm_Hitbox",tag=!mvm_headHitbox,distance=..0.3,limit=1,sort=nearest] run tag @e[team=mvm_enemies,limit=1,sort=nearest] add mvm_damageMinicrit
