...
execute as @s[scores={mvm_distance=21..99}] if score @p[team=mvm_players,distance=..1] mvm_id = @s mvm_healTarget run scoreboard players set @s mvm_medibeamActive 10
execute as @s[scores={mvm_distance=21..99}] if score @p[team=mvm_players,distance=..1] mvm_id = @s mvm_healTarget run execute as @p[team=mvm_players,distance=..1] run function mvm:classes/medic/heal
execute as @s[scores={mvm_distance=21..99}] if score @p[team=mvm_players,distance=..1] mvm_id = @s mvm_healTarget run scoreboard players set @s mvm_distance 103
