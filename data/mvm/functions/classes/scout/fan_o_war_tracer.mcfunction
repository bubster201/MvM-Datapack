...
tag @e[type=marker,name="mvm_Hitbox",distance=..1,limit=1,sort=nearest] add mvm_marked
scoreboard players operation @e[type=marker,name="mvm_Hitbox",distance=..1,limit=1,sort=nearest] mvm_damageDealer = @s mvm_id
scoreboard players add @e[type=marker,name="mvm_Hitbox",distance=..1,limit=1,sort=nearest] mvm_applyDamage 9