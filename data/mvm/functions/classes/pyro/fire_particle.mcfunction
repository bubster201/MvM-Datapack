...
tp @s ^ ^ ^-0.8
tag @e[type=marker,name="mvm_Hitbox",distance=..1] add mvm_burning
scoreboard players set @e[type=marker,name="mvm_Hitbox",distance=..1] mvm_burnTime 0
execute as @s[tag=mvm_critBoosted] run tag @e[type=marker,name="mvm_Hitbox",distance=..1] add mvm_damageCrit
execute as @s[tag=mvm_buffed] run tag @e[type=marker,name="mvm_Hitbox",distance=..1] add mvm_damageMinicrit
scoreboard players operation @e[type=marker,name="mvm_Hitbox",distance=..1,limit=1,sort=nearest] mvm_damageDealer = @s mvm_id
scoreboard players add @e[type=marker,name="mvm_Hitbox",distance=..1] mvm_applyDamage 9
