...
execute as @s[nbt={SelectedItem:{tag:{slot1:1b}}}] run title @s actionbar [{"text":"Ammo: ","color":"red"},{"score":{"name":"@s","objective":"mvm_ammo1"},"color":"yellow"}]
execute as @s[nbt={SelectedItem:{tag:{slot2:1b}}}] run title @s actionbar [{"text":"Ammo: ","color":"red"},{"score":{"name":"@s","objective":"mvm_ammo2"},"color":"yellow"}]
...
execute as @s[scores={mvm_reload1=2,mvm_ammo1=0..}] run function mvm:classes/refill_ammo1
