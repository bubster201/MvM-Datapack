execute as @e[team=mvm_enemies,distance=..5] run scoreboard players operation @s mvm_enemyIdDiff = @s mvm_enemyId
scoreboard players operation @e[team=mvm_enemies,distance=..5] mvm_enemyIdDiff -= @s mvm_enemyId
