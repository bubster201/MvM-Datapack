...
execute if block ~1 ~ ~ minecraft:green_wool run execute as @e[type=marker,name="mvm_EnemySpawn"] at @s run summon zombie ~ ~ ~ {CustomName:'"Bat Scout"',Tags:[mvm_enemy,mvm_health125],HandItems:[{id:"minecraft:bone",Count:1b}],Attributes:[{Name:"generic.follow_range", Base:1000.0}]}
